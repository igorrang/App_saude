...
export default function InformacoesImportantes() {
    ...
    return (
        <View>
            <Box width="100%" mb={1} px={4} py={2} backgroundColor="#fff" shadow="4" _text={{ color: 'orange.400', fontSize: 16, fontWeight: 'bold' }}>
            ...
            <Text color="#777" fontSize={13} p={2} style={{textAlign: 'justify'}}>
                ...
                <Link href="https://www.ipesaude.rs.gov.br/carta-de-servicos/servicos?servico=2055" isExternal _text={{
                    color: "orange.400"
                }} mt={-0.5} _web={{
                    mb: -2
                }}>
