  ...
  return (
    <>
      <Center>
        ...
        >
          <Icon as={<MaterialIcons name="search" />} size={6} color="gray.200" />
        </Button>
      </Center>
      <Modal isOpen={isSearchOpen} onClose={() => setIsSearchOpen(false)} >
        <View bg='white' height="38%" position="absolute" top="0" left="0" right="0" bottom="0" opacity={0.9} >
          <View bg="white" py={2} px={2} flexDirection="row">
            <Button
              bg="white"
              alignSelf="center"
              ...
              background={'white'}
            >
              <Icon as={<AntDesign name="arrowleft" />} size={5} color="orange.500" marginTop='4' background={'transparent'} />
            </Button>
            <Input
              ...
              fontSize='sm'
              placeholder={title}
              InputLeftElement={<Icon as={<MaterialIcons name="search" />} size={6} ml="2" mr='-1' color="orange.500" />}
              InputRightElement={<Icon as={<MaterialIcons name="cancel" />} size={5} ml="2" mr='2' color="orange.500" onPress={Clear} />}
              height={35}
              shadow='2'
              mx={2}
              flex={1}
