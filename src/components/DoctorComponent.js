            ...
            <Flex direction="column">
                ...
                <Box width='100%' my='5'>
                    ...
                    <Flex direction="row">
                                            ...
                                            {/*Whatsapp icons */}
                    <Icon as={Entypo} name="phone" color='green.400'      onPress={openWhatsApp}      size={25} mr="-7"   mt="4" />
                    <Icon as={FontAwesome} name="whatsapp" color='muted.200' onPress={openWhatsApp}      size={47} mr="-51"  mt="-0.6" />
                    <Icon as={Entypo} name="controller-record" color='green.400' onPress={openWhatsApp}  size={49} mt="-0.5" mr="-1"/>
                    <Icon as={FontAwesome} name="whatsapp" color='muted.100' onPress={openWhatsApp}     size={45} ml="-10" />

                        <Text fontSize='18' color='green.400' onPress={openWhatsApp} bold mt='2' ml='2'>{phone} </Text>
                    </Flex>
                </Box>
