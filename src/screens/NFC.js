            ...
            <Box bg='white' w='95%' h='93%' alignSelf='center' shadow={3} p={5} mt={5} borderRadius={15}>
                <Stack w="100%" h="100%" mx="auto" alignItems="center" justifyContent="flex-start" marginY="2">
                    <View>
                        ...
                        <Input w="100%" mt={3} borderColor="green.600" borderRadius="10" bg="white" placeholder='Status' editable={false}>{sim}</Input>
                        <Text marginTop="5" alignSelf="flex-start" bold color="gray.800" fontSize="md">Texto:</Text>
                        <Input mt={3} borderColor="orange.500" borderRadius="10" bg="white" placeholder="Digite aqui o seu texto" w="100%" onChangeText={onChangeText} />
                        <Button borderRadius="20" bg="green.600" shadow={3} px="20" size="lg"
                            _pressed={{ backgroundColor: 'green.600', opacity: 0.5 }} mt={5} onPress={() => handleStartSimulation()}>Começar Simulação</Button>
                        <Button borderRadius="20" bg="green.600" shadow={3} px="20" size="lg"
                            _pressed={{ backgroundColor: 'green.600', opacity: 0.5 }} mt={5} onPress={() => stopSession()}>Parar a simulação</Button>
                    </View>
                        ...
                        <Modal.Content>
                            <Fade in={showModal} onExit={() => setSim('')}>
                                <Box p={5} bg="white" rounded="lg" shadow={4} alignItems="center" justifyContent="center">
                                    ...
                                    <ActivityIndicator color="green.600" size="large" />
                                </Box>
                            </Fade>
                        </Modal.Content>
                    </Modal>
