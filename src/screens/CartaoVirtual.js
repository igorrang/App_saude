                            ...
                            <View style={{ position: 'relative' }}>
                                ...
                                />
                                    ...
                                    <View flex={0.33} justifyContent={'flex-start'}>
                                        ...
                                        <Input mt={3} borderColor="green.600" borderRadius="10" bg="white" placeholder="Digite aqui o seu texto" w="100%" onChangeText={onChangeText} />
                                    </View>
                                    ...
                                    <View flex={0.34} justifyContent={'center'}>
                                        <View flexDirection={'row'} justifyContent={'space-between'}>
                                            <Button marginRight={10} color='white' borderRadius="20" bg="green.600" _text={{ color: 'white' }} shadow={3} size="lg" title={'Cancelar'}
                                                _pressed={{ backgroundColor: 'green.600', opacity: 0.5 }} onPress={() => stopSession()} />
                                            <Button marginRight={2} color='white' borderRadius="20" bg='green.600' shadow={3} size="lg" title={'Começar'}
                                                _pressed={{ backgroundColor: 'green.600', opacity: 0.5 }} onPress={() => handleStartSimulation()} />
                                        </View>
                                    </View>
                                </Box>
                            </View>
