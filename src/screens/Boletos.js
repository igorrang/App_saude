    ...
    return (
        <Box >
            <View bg='white' w='90%' h='100%' alignSelf='center' shadow={3} p={5} pb={30} mt={5} borderTopRadius={10}>
                ...
                <Select mt="2" borderColor="orange.500" borderRadius="10" bg="white" shadow={3} selectedValue={matricula} minWidth="100%" accessibilityLabel="Escolha uma opção:" placeholder="Selecione a matrícula:" _selectedItem={{
                    endIcon: <CheckIcon />
                }} _light={{
                    bg: "white"
                }}
                                ...
                                <Modal.Content maxWidth="400px">
                                    ...
                                    <Modal.Footer>
                                        <Button.Group space={2}>
                                            ...
                                            <Button bg='green.600' color='white' onPress={() => { setBtnCopiar('Copiado!') }}>
                                                {btnCopiar}
                                            </Button>
                                        </Button.Group>
                                    </Modal.Footer>
