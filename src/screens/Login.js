...
export function Login({ navigation }) {
    const { setAuthData, setUserUid, setUserNome, setUserEmail, userMatricula, setUserMatricula, familia, setFamilia } = useContext(AuthContext);
    ...
    const fetchUser = async (matricula) => {
        setCarregando('carregando')
        apiFetch(`https://sechml.procergs.com.br/sbi-services/api/ipespa/grupo-familiar/${matricula}`).then((res) => {
            return res.data
        }).then((data) => {
    ...
    return (
        ...
        <View flex={1}  >
            ...
            <HStack zIndex={3} space={0} justifyContent="center">
                <Center h="1" w="35%" bg="green.600" m="0" shadow={3} />
                <Center h="1" w="35%" bg="orange.500" shadow={3} />
                <Center h="1" w="35%" bg="green.500" shadow={3} />
            </HStack>
                ...
                <ScrollView contentContainerStyle={{ flexGrow: 1, }} flex={0.2} >
                    ...
                    <View flex={1} mx='4'>
                        ...
                        <Box mb={10} flex={0.65} justifyContent='flex-start' alignItems='center' >
                            <Heading mb='2' color="#ff9626" size="lg">Seja bem-vindo!</Heading>
                            <Text mb='6' fontSize={18} color="#005B36">Acesse sua conta de forma segura:</Text>
            ...
            <HStack zIndex={2} space={0} style={{ position: 'absolute', bottom: 0 }} justifyContent="center">
                <Center h="1" w="35%" bg="green.600" />
                <Center h="1" w="35%" bg="orange.500" />
                <Center h="1" w="35%" bg="green.500" />
            </HStack>
