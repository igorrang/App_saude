...
export default function HabilitacaoDependentes({ navigation }) {
  ...
  <Box borderWidth={1} shadow={5} rounded={5} borderColor="orange.400">
    ...
    InputRightElement={<Icon as={<MaterialIcons name="cancel" />} size={5} ml="2" mr='2' color="orange.500" />}
    />
  </Box>
  <Box borderWidth={1} shadow={5} rounded={5} mt={1}  borderColor="orange.400">
