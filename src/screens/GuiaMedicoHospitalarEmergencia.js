    ...
    return (
        <Box >
            <Stack w="80%" h="100%" mx="auto" alignItems="center" justifyContent="flex-start" marginY="10">
                <HStack space={5}>
                    <Button onPress={() => navigation.navigate('GuiaMedicoHospitalar')} borderColor="gray.300" borderWidth="2" borderRadius="20" w="45%" bg="white" fontWeight="bold" _text={{ color: "gray.300" }} _pressed={{backgroundColor: 'orange.500', _text:{color: 'white'}}}>Serviços</Button>
                    <Button borderColor="orange.500" borderWidth="2" borderRadius="20" w="45%" bg="white" fontWeight="bold" _text={{ color: "orange.500" }} _pressed={{backgroundColor: 'orange.500', _text:{color: 'white'}}}>Emergência</Button>
                </HStack>
                ...
                <Checkbox marginY="5" maxWidth="80%" size="sm" value="test" _checked={{bgColor:'green.600', borderColor: 'green.600'}}>Exibir resultados em municípios próximos</Checkbox>

                <Button borderRadius="20" bg="green.600" shadow={3} px="20" size="lg">Buscar</Button>
            </Stack>
        </Box>
    )
}