  ...
  return (
    ...
    <Box bg='white' w='95%' h='93%' alignSelf='center' shadow={5} p={5} mt={5} borderRadius={15}>
      ...
      <Stack w="100%" maxW="300px" mx="auto"  >
          ...
          <Button w='100%' h='50' backgroundColor='#00b188' mt='4'  onPress={onOpen} endIcon={<Icon as={EvilIcons} color='#fff' name="plus" size="xl" marginLeft="20" />} _icon={{

          }}>
            <Text top="-1.15" mt='0' mr='-10' color='#fff' bold fontSize='16' >Enviar os seguintes arquivos</Text>
          </Button>
          <Actionsheet isOpen={isOpen} onClose={onClose}>
            <Actionsheet.Content _dragIndicator={{
              ...
              <Actionsheet.Item>●  Certidão de casamento atualizada (expedida até 90 dias);</Actionsheet.Item>
              <Actionsheet.Item>●  RG e CPF do cônjuge (frente e verso);</Actionsheet.Item>
